...
import { AESbase64, AESbase64url } from "../config/utils";
    ...
    function request_util(
      ...
      if (responseTransformer) {
        options.transformResponse =
          defaults.transformResponse.concat(responseTransformer);
      }
